...
#+begin_src clojure
  [ajchemist/boot-figwheel "0.5.4-4"] ;; latest release
...
- [[https://github.com/aJchemist/cljs-devtools-sample/blob/9869b753b01638801d3e704f62a10d03abbb6ca6/build.boot][cljs-devtools-sample]] project
...
- Add a new task-option of =figwheel=, called =once-ids= to specify configurations which are going to be built once.
