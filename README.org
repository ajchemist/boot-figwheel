...
Want to see more real usage, see also [[https://github.com/aJchemist/rum-mdl][rum-mdl]] project [[https://github.com/aJchemist/rum-mdl/blob/master/build.boot][build.boot]] file.
